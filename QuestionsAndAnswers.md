https://github.com/ansa-sequence/Interview/blob/main/QuestionsAndAnswers.md
...
## 3 | 16. Когда вызывается конструктор копирования, а когда копирующий оператор присваивания?
...
## 3 | 22. Что лучше const или define?
...
## 3 | 24. Как определить размер массива?
```c++
...
## 1 | 35. Что быстрее постфиксные инкрементные операторы или префиксные? Чем отличается их сигнатура?
